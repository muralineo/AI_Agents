...
from agent_language import AgentFunctionCallingActionLanguage
from environment import Environment
from goals_actions import Goal, ActionRegistry, Action
...
agent_language = AgentFunctionCallingActionLanguage()  # formating the prompt, result
...
environment = Environment()  # to execute the actions
